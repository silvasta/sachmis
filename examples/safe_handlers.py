...
# INFO: this was the initial test (here) before the module in sstcore

# MERGE: maybe something can be reused or was forgotten: __init__ + attach()
...
# MERGE: maybe something can be reused or was forgotten: __call__
...
# MERGE: maybe something can be reused or was forgotten: try if possible inside class
@app.command()
def throw(index: int):
...
def run_app(index: int, stress_test=True, error_name: str = ""):
    ...
    # MERGE: maybe something can be reused or was forgotten: BaseException
